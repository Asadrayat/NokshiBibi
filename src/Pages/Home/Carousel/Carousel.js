        ...
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide4" className="text-2xl  lg:text-5xl text-red-600">❮</a>
                    <a href="#slide2" className="text-2xl  lg:text-5xl text-red-600">❯</a>
                </div>
            </div>
            <div id="slide2" className="carousel-item relative w-full">
                <img src={img2} alt='avatar' className="w-full" />
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide1" className="text-2xl  lg:text-5xl text-red-600">❮</a>
                    <a href="#slide3" className="text-2xl  lg:text-5xl text-red-600">❯</a>
                </div>
            </div>
